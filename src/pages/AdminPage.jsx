...
/*
<div className ="container d-flex justify-content-center align-items-center vh-100 flex-wrap overflow-scroll" >
    ...
    <CardComponent img={"https://mundohol.cordoba.gob.ar/wp-content/uploads/sites/5/elementor/thumbs/Manual-de-usuario-2-pey55ogoumj9xeul3rxw305q7npn1aomf3wppkx1o8.png"} url={"/isacepted"} name={"Habilitación"} />
